...
;; provides   M-x recentf-open-files
(require 'recentf)
(recentf-mode 1)
...
;; remember and restore the last cursor location of a file
(save-place-mode 1)
...
;; emacs mode docs: https://github.com/abingham/flycheck-vale
;; vale docs: https://docs.errata.ai/vale/about
;; vale repo: https://github.com/errata-ai/vale
;; vale configuration: ~/.vale.ini  and ~/.local/share/vale/styles
...
(global-set-key (kbd "C-c |") 'theme-looper-enable-random-theme)

;;favorite themes:   kooten
